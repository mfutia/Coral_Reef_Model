...
![Individual flow diagram representing societal factors that influence the willingness of the public to participate in coral reef conservation.](https://github.com/mfutia/Coral_Reef_Model/blob/master/SimpleModel_Futia.png)


![Team flow diagram representing societal factors that influence the willingness of the public to participate in coral reef conservation.](https://github.com/mfutia/Coral_Reef_Model/blob/master/Case Study Flow Chart.png)
...
![Team flow diagram representing ecological and societal factors that influence coral reef conservation.](https://github.com/mfutia/Coral_Reef_Model/blob/master/Eco_SocioFlowChart.png)
